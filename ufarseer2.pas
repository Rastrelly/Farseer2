...
var
  ...
  contrast:Integer=100; //перепад цветов для детекции объекта
...
//считает расстояние на основе попиксельного анализа
...
begin
  ...
  begin
    if phase=0 then
    begin
      StatusBar1.Panels[1].Text:='Автоматиченское измерение длины. Укажите первую точку.'
    end;
    if phase=1 then
    begin
      StatusBar1.Panels[1].Text:='Автоматическое измерение длины. Укажите вторую точку.'
    end;
    if phase=2 then
    begin
      mode:=0;
  ...
  begin
    if phase=0 then
    begin
      StatusBar1.Panels[1].Text:='Пакетное измерение длины. Укажите первую точку линии измерения.'
    end;
    if phase=1 then
    begin
      StatusBar1.Panels[1].Text:='Пакетное измерение длины. Укажите вторую точку линии измерения.'
    end;
    if phase=2 then
    begin
      StatusBar1.Panels[1].Text:='Пакетное измерение длины. Укажите первую точку зоны измерения.'
    end;
    if phase=3 then
    begin
      StatusBar1.Panels[1].Text:='Пакетное измерение длины. Укажите вторую точку зоны измерения.'
    end;
    if phase=4 then
    begin
      mode:=0;
